         ...
         <div class="col-md-6">
            <div class="form-group">
               ...
               <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="idTourDateDetails" name="dob" required="required" placeholder="DD-MM-YYYY" value="<?php $d=($objectStudent->DOB!=date('Y-m-d',strtotime("
                     0000-00-00 ")))?" ":$objectStudent->DOB;echo $d;?>">
               </div>
            </div>
         </div>
         <div class="col-md-12">

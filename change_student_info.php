...
<div class="container-fluid content-container ">
   <div class="jumbotron change-student-info" id="<?php echo $obj->UID; ?>">
      <h2 style="margin-top: -17px">
         <?php echo "UID : $obj->UID"?>
      </h2>
      ...
      <div class="form-group">
         ...
         <input type="date" id="idTourDateDetails" class="form-control" required="required" value="<?php echo date(" Y-m-d
            ",strtotime($obj->DOB)); ?>">
      </div>
